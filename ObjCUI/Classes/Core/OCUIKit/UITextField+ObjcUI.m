...
- (OCUITextFiledDelegateWarp *)delegateBlockMap {
    OCUITextFiledDelegateWarp *delegateWarp = objc_getAssociatedObject(self, UITextFieldObjcUIDelegateKey);
    if (!delegateWarp) {
        delegateWarp = [[OCUITextFiledDelegateWarp alloc] init];
